...
/**
 * Control authorized access to admin restricted sections
 * @author devis
 */
public class SecretFilter implements Filter {
    ...
    private void doBeforeProcessing(RequestWrapper request, ResponseWrapper response)
        ...
        Boolean adminLogged = (session!=null)? (Boolean) session.getAttribute("admin") : null;
        if(adminLogged == null || !adminLogged){
            //unauthorized request
            request.setAttribute("error_msg", "Action not authorized!");  
            request.getRequestDispatcher("landing.jsp").forward(request, response);
        }
        //otherwise, flow can proceed, i.e. authorized admin
    }    
